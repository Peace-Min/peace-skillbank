...
4. Look for likely retainers: static caches, dictionaries, lists, observable collections, event handlers, timers, task continuations, closures, dispatcher queues, service singletons, view models, views, bitmaps, byte arrays, and strings.
...
2. Evidence table
3. Most likely retention mechanism
