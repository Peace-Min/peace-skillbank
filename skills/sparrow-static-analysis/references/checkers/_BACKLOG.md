...
트랙 배정: **A**=SparrowSyntaxFix 자동(완료) · **B**=SparrowCommentFix/whitespace 결정론 · **C**=LLM/사람 판단.
...
## 집계
- **A (자동, SparrowSyntaxFix)**: 4종, **~4,105건** — 완료(Run-SparrowSyntaxFix).
- **B (결정론 자작/whitespace)**: 11종, **~2,700건** — 주석 5종(~1,950)=SparrowCommentFix, 여백 6종(~750)=`SparrowCommentFix layout`.
